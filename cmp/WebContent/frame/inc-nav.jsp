...
<div id="nav-box">
	...
	<ul id="browser" class="filetree">
		<li><span class="folder">订单模块</span>
			<ul>
            	<li><span class="file"><a onclick="urlTarget('${pageContext.request.contextPath }/controller/order?flag=query');">订单管理</a></span></li>
            	<li><span class="file"><a onclick="urlTarget('${pageContext.request.contextPath }/controller/orderdetail?flag=query');">订单审核</a></span></li>
		  </ul>
	  </li>
	<li><span class="folder">配件模块</span>
			<ul>
            	<li><span class="file"><a onclick="urlTarget('${pageContext.request.contextPath }/controller/parts?flag=query');">配件管理</a></span></li>
				<li><span class="file"><a onclick="urlTarget('${pageContext.request.contextPath }/controller/partsrepertory?flag=query');">配件出入库管理</a></span></li>
				<li><span class="file"><a onclick="urlTarget('${pageContext.request.contextPath }/controller/partsrepbill?flag=query');">配件出入库流水查询</a></span></li>
		  </ul>
	  </li>
