...
function showMaterials(){
	...
	//时间戳
	var url = "${pageContext.request.contextPath }/controller/order?flag=getmater";
...
$(function(){
	$("#saveBtn").click(function(){
		$.ajax({
			url:"${pageContext.request.contextPath}/controller/order?flag=save",
			type:"post",
			data:$("#coursesCreat").serialize(),
        ...
        <form id="coursesCreat" name="coursesCreat" action="" method="post">
		  <table border="0" cellspacing="1" cellpadding="0" class="commonTable">
			  <tr>
				...
				<td width="15%" align="left" name="orderDate"></td>
